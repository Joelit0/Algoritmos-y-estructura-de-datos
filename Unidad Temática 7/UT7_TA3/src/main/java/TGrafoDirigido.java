...
public class TGrafoDirigido implements IGrafoDirigido {
    ...
    public Comparable centroDelGrafo() {
        ...
        Comparable menor_excentricidad = 1000000.0;

        for (final TVertice t : this.vertices.values()) {
            Comparable excentricidad = this.obtenerExcentricidad(t.getEtiqueta());
    ...
    public Comparable obtenerExcentricidad(Comparable etiquetaVertice) {
        ...
        if (vertice != null) {
            ...
            for (final TAdyacencia a : adyacentes) {
                if (a.getCosto() > mas_lejano) {
                    mas_lejano = a.getCosto();
